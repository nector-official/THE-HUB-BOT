...
const update = async (m, sock) => {
    ...
    const sent = await sock.sendMessage(m.from, {
        image: { url: 'https://files.catbox.moe/03qy6k.jpg' }, // Thumbnail
    ...
    try {
        const { data: commitData } = await axios.get('https://api.github.com/repos/drapterlagas/THE-HUB-BOT/commits/main');
        ...
        const zipUrl = 'https://github.com/drapterlagas/THE-HUB-BOT/archive/refs/heads/main.zip';
        ...
        const sourceDir = path.join(extractTo, 'THE-HUB-BOT-main');
